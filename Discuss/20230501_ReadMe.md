...
* [二、Semi-automatic labeling](#5-使用Sklearn上演算法驗證分群效果)
  * [（一）最佳分群數](#6-使用Sklearn上演算法驗證分群效果)  
     * [1.Silhouette Score](#7-silhouette-score) 
     * [2.Calinski-Harabasz Index](#8-calinski-harabasz-index) 
     * [3.Davies-Bouldin Index](#9-davies-bouldin-index) 
     * [4.Elbow Method](#10-elbow-method) 
* [三、動作觀察](#11-動作觀察)  
  * [（一）動作差異](#12-動作差異) 
...
* [四、Probabilistic Suffix Tree](#18-Probabilistic Suffix Tree-1)   
  * [（一）依不同Acton建立分別的 Probabilistic Suffix Tree model （5 Action Element）](#18-Probabilistic Suffix Tree-2) 
     * [（1）怠速](#18-Probabilistic Suffix Tree-3) 
     * [（3）直線](#18-Probabilistic Suffix Tree-4)  
     * [（4）左轉](#18-Probabilistic Suffix Tree-5)  
     * [（5）右轉](#18-Probabilistic Suffix Tree-6)  
     * [（6）待轉](#18-Probabilistic Suffix Tree-7)   
     * [（7）迴轉](#18-Probabilistic Suffix Tree-8) 
  * [（二）依不同Acton建立分別的 Probabilistic Suffix Tree model （4 Action Element）](#19-Probabilistic Suffix Tree-2) 
     * [（1）怠速](#19-Probabilistic Suffix Tree-3) 
     * [（3）直線](#19-Probabilistic Suffix Tree-4)  
     * [（4）左轉](#19-Probabilistic Suffix Tree-5)  
     * [（5）右轉](#19-Probabilistic Suffix Tree-6)  
     * [（6）待轉](#19-Probabilistic Suffix Tree-7)   
     * [（7）迴轉](#19-Probabilistic Suffix Tree-8)  
  * [（三）依不同Acton建立分別的 Probabilistic Suffix Tree model （3 Action Element）](#20-Probabilistic Suffix Tree-2) 
     * [（1）怠速](#20-Probabilistic Suffix Tree-3) 
     * [（3）直線](#20-Probabilistic Suffix Tree-4)  
     * [（4）左轉](#20-Probabilistic Suffix Tree-5)  
     * [（5）右轉](#20-Probabilistic Suffix Tree-6)  
     * [（6）待轉](#20-Probabilistic Suffix Tree-7)   
     * [（7）迴轉](#20-Probabilistic Suffix Tree-8)  
...
### 1.Silhouette Score <a name="7-Silhouette Score"></a>
...
### 2.Calinski-Harabasz Index <a name="8-Calinski-Harabasz Index"></a>
...
### 3.Davies-Bouldin Index <a name="9-Davies-Bouldin Index"></a>
...
### 4.Elbow Method <a name="10-Elbow Method"></a>
...
#### （1）左轉右轉比較 （不相似）<a name="15-動作元素5群-1"></a>
...
# 四、Probabilistic Suffix Tree <a name="18-Probabilistic Suffix Tree-1"></a>
## （一）依不同Acton建立分別的 Probabilistic Suffix Tree model （5 Action Element）<a name="18-Probabilistic Suffix Tree-2"></a>

### 1.怠速 <a name="18-Probabilistic Suffix Tree-3"></a> 
...
### 2.直線 <a name="18-Probabilistic Suffix Tree-4"></a>
...
### 3.轉左 <a name="18-Probabilistic Suffix Tree-5"></a>
...
### 4.右轉 <a name="18-Probabilistic Suffix Tree-6"></a>
...
### 5.待轉 <a name="18-Probabilistic Suffix Tree-7"></a>
...
### 6.迴轉 <a name="18-Probabilistic Suffix Tree-8"></a>
...
### 模型預測（5 Action Element） <a name="18-Probabilistic Suffix Tree-9"></a>
...
## （二）依不同Acton建立分別的 Probabilistic Suffix Tree model （4 Action Element）<a name="19-Probabilistic Suffix Tree-2"></a>

## （三）依不同Acton建立分別的 Probabilistic Suffix Tree model （3 Action Element）<a name="20-Probabilistic Suffix Tree-2"></a>
